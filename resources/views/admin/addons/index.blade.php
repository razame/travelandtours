    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Package Addons</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active"><a href="#">Package Addons</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <div class="card-tools">
                            <a class="btn btn-primary pull-right" href="{{route('addons.create')}}">Create Addon</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($addons as $addon)
                                        <tr>
                                            <td>{!!$addon->title!!}</td>
                                            <td>
                                                <a class="btn btn-primary" href="{{route('addons.edit', $addon->id)}}">Edit</a>
                                            </td>
                                            <td>
                                                <form action="{{route('addons.destroy', $addon->id)}}" id="delete{{$addon->id}}" method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="button" class="btn btn-danger" onclick='confirmDelete("{{$addon->id}}", "Addon")'>Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
